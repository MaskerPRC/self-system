...
https://github.com/MaskerPRC/self-system/raw/master/docs/video/f38372862cabd841faa8d031c51a0888.mp4

> 用户说"帮我搞一个最简单的页面计数器" → AI 自动编写代码、安装依赖、启动 Docker 容器、提交 Git —— 全程一次对话完成。

#### 仪表板总览 — 所有生成的应用一目了然

https://github.com/MaskerPRC/self-system/raw/master/docs/video/1275a53ad006f047c490be31b4eba576_raw.mp4

> 交互集合仪表板：项目卡片展示、集成 AI 对话、文件系统浏览器、全屏预览功能。

#### 技能与设置管理

https://github.com/MaskerPRC/self-system/raw/master/docs/video/217e4327ab9b0a6768844f80d9bab6c5.mp4

> 一键开关各种技能：网页搜索、Telegram、微信、视频分析等。配置 Git 远程仓库，查看版本历史。

#### AI 生成的英语词汇学习 App

https://github.com/MaskerPRC/self-system/raw/master/docs/video/53fb12832c51c289c51660a11a53d57f.mp4

> 支持四六级/雅思词汇学习，每个单词配有谐音记忆法、职业定制例句、学习进度追踪 —— 完全由 AI 对话生成。

#### 移动端体验 — 任务管理与学习

https://github.com/MaskerPRC/self-system/raw/master/docs/video/f8882e7d95c42b10e3160d969db59fc5.mp4

> PWA 移动端：闲时任务管理器和英语学习应用共享后端。已学词汇 984 个，收集表达 295 条。

#### 场景化闲时任务管理

https://github.com/MaskerPRC/self-system/raw/master/docs/video/ff08ec121de5ba8ae833b14894d513f5.mp4
