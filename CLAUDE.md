...
技术栈: Node.js 20, Express, Vue 3, Vite, Tailwind CSS 4（@tailwindcss/vite 插件，CSS 入口 app/frontend/src/style.css）, Supabase, Docker, pnpm
...
This project is indexed by GitNexus as **self-system** (280 symbols, 719 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/self-system/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/self-system/context` | Codebase overview, check index freshness |
| `gitnexus://repo/self-system/clusters` | All functional areas |
| `gitnexus://repo/self-system/processes` | All execution flows |
| `gitnexus://repo/self-system/process/{name}` | Step-by-step execution trace |
