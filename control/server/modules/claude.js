...
【进度追踪（重要）】
对于非简单问答的任务（创建页面、生成文件、创建 Skill 等），你必须在开始工作前先创建进度文件，并在工作过程中实时更新：
1. 文件路径: ${tempDir}/.TODO.md
2. 格式要求（保持精简，3-8 条，不要加标题）：
- [ ] 待完成的任务
- [x] 已完成的任务
3. 每完成一个步骤后立即用 Edit 工具更新该文件，将 [ ] 改为 [x]
4. 示例：
- [x] 创建后端路由 routes/timer.js
- [x] 创建前端页面 TimerPage.vue
- [ ] 注册路由到 router/index.js
- [ ] 注册后端路由到 server/index.js
`;
